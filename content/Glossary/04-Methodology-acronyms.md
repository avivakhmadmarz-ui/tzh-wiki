...
aliases: 
updated: YYYY-MM-DD
tags: [education, glossary, acronyms]
created: 2026-05-07
date created: 2026-05-07
date modified: 2026-05-13
---

# Methodology Acronyms — аббревиатуры методологий и систем

Все аббревиатуры методологий, фреймворков, систем и сертификаций, которые встречаются в твоей программе обучения. Если запутался в супе из англоязычных букв — открывай этот файл.

## Группировка по семантике

- **Планирование операций**: S&OP, IBP, MRP, MRP II, ERP, DDMRP, APS, S&OE
- **Lean / TPS**: TPS, JIT, TPM, SMED, VSM, 5S, A3, DBR
- **Качество**: TQM, Six Sigma, LSS, DMAIC, DFSS, QFD
- **Целеполагание**: OKR, KPI, BSC, MBO, WIG (4DX), Rocks (EOS)
- **Стратегия / governance**: Hoshin Kanri, RACI, RAPID, RICE, OKR-pyramid
- **Системы для SMB**: EOS, 4DX, Holacracy, Scrum, Agile, Kanban-method
- **Финансы**: ZBB, BB (Beyond Budgeting), AOP, Driver-based planning
- **ToC**: ToC, DBR, CCPM, S-DBR, TOCICO
...
**B2B / B2C / D2C** — Business-to-Business / Business-to-Consumer / Direct-to-Consumer. Типы продаж/маркетинга.

**BCG matrix** — Boston Consulting Group matrix: Stars / Cash Cows / Question Marks / Dogs. Старый, но часто упоминаемый инструмент портфельного анализа.
...
**CEO / CFO / COO / CSCO / CIO / CTO / CMO / CHRO** — топ-менеджерские роли:
...
**CPIM** — Certified in Production and Inventory Management. Главная APICS/ASCM-сертификация по производству и запасам.

**CSCP** — Certified Supply Chain Professional. APICS/ASCM-сертификация по end-to-end supply chain.
...
**GTD** — Getting Things Done. David Allen, методология личной продуктивности. Не корпоративная, но часто упоминается.
...
**OEE** — Overall Equipment Effectiveness. См. [[01-Operations-metrics|Operations]].
...
**OTIF** — On-Time In-Full. См. [[01-Operations-metrics|Operations]].
...
**PMI / PMBOK** — Project Management Institute / Project Management Body of Knowledge. Классический проектный стандарт. Альтернатива — PRINCE2 (Британия).

**Poka-Yoke** (ポカヨケ) — защита от ошибок. См. [[01-Operations-metrics|Operations]].

**POOGI** — Process of Ongoing Improvement. ToC-термин для 5 focusing steps как непрерывного цикла.

**PRINCE2** — Projects in Controlled Environments. UK government стандарт проектного управления.
...
**RICE** — Reach × Impact × Confidence / Effort. Фреймворк приоритизации продуктовых фич (Intercom).

**Rocks** (EOS) — квартальные приоритеты в EOS. Близкий родственник OKR, но проще: 3-7 ключевых задач на квартал.
...
**Scrum** — Agile фреймворк для software development. Sprint, Product Owner, Scrum Master, Daily standup.

**SIPOC** — Supplier-Input-Process-Output-Customer. Six Sigma инструмент для high-level mapping процесса.
...
**STL** — Single-Threaded Leader. Amazon-практика: один человек владеет одной целью на 100%, без распыления внимания.
...
**WACC** — Weighted Average Cost of Capital. См. [[02-Financial-metrics|Financial]].

**WIG** — Wildly Important Goal. Главная цель в фреймворке 4DX (1-2 на команду).

**WBR** — Weekly Business Review. Amazon-практика: 6-страничный документ + молчаливое чтение + обсуждение метрик.

**WIP** — Work in Progress. Незавершённое производство. В Lean WIP = waste, минимизировать.
...
- [[05-Concepts-and-laws|Concepts & Laws]]

## Источники

- [Investopedia](https://www.investopedia.com/) — большинство финансовых аббревиатур
- [ASCM Dictionary](https://www.ascm.org/) — supply chain
- [Lean Lexicon — LEI](https://www.lean.org/lexicon-terms/) — Lean
- [PMI Glossary](https://www.pmi.org/) — проектный
- [Atlassian Agile Coach](https://www.atlassian.com/agile) — Agile / Scrum / Kanban
